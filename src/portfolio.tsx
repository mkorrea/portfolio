    ...
    <div className="flex items-center flex-col ">
      ...
      <main className="relative w-[1920px] max-w-full ring-border ring-2 z-10 bg-bg-color overflow-x-hidden ">
        ...
        <div id="about" className="relative h-fit flex flex-col items- my-12 z-0   ">
          <div className="absolute top-0 right-0 flex justify-center items-center font-bold text-sm h-9 min-w-36 w-[34vw] max-w-64 -mr-[1px] rounded-l-full pr-3 z-10 transition-all ease-linear
          ...
          ">
            <p className="text-[2.7vw] text-zinc-300 text-center leading-relaxed max-w-[800px] 
              ...
              xl:w-[50vw]
            ">
              <HandWaving className="text-indigo-500 inline animate-wave size-6  " /> Olá, sou <span className="text-indigo-500">Matheus</span>! <br/>
